...
public class ProductController {
    ...
    @Autowired
    public void setProductService(ProductService productService, TeamService teamService, TaskService taskService, TeamSkillService teamSkillService) {
...
//        taskService.insertTaskData();
//        teamSkillService.insertTeamSkillData();
